...
val teachingScript = listOf(
    ...
    "Picture this: Osman Pasha, a figure of unwavering resolve, leading the Ottoman forces against a formidable Russian and Romanian alliance.",
    "Despite overwhelming numerical odds, Osman Pasha and his troops displayed exceptional bravery, showcasing the epitome of military courage.",
    "The siege, a true test of mettle, concluded in December 1877.",
    "Despite the remarkable resistance led by Osman Pasha, the Ottoman forces were eventually overcome by the superior might of the Russian and Romanian troops. ",
